...
(function (dnd) {
    ...
    function drag(draggable, callback) {
        var storeId = wnd.__latest++;
    ...
    dnd.drag = drag;
    function drop(storeId, droppable) {
        var desc = wnd.__stores[storeId];
        var store = desc.store;
        var dataTransfer = desc.dataTransfer;
        var draggable = desc.draggable;
